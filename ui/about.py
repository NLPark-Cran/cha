    ...
    def build(self) -> ft.Control:
        ...
        return ft.Column(
            [
                ...
                self._section(
                    "🟢 什么是观猹？",
                    "观猹（watcha.cn，似一科技）是中文互联网首个\"AI 产品的大众点评\"，"
                    "2025 年 7 月正式上线。平台由 2002 年出生的连续创业者仲泰创立，"
                    "其创业轨迹从高三搭建试题交流平台，到大学运营考题答疑社群，"
                    "再到 2023 年创立科技自媒体\"特工宇宙\"，最终在 AI 应用爆发期打造出观猹这一社区平台。\n\n"
                    "观猹获得了红杉中国与华兴资本的种子轮投资。"
                    "平台核心定位是\"观察\"——让用户发现､体验并评价各种新奇有趣的 AI 产品，"
                    "也让 AI 开发者和超级个体（Builders）找到第一批真实用户，"
                    "获取产品反馈与商业合作机会。"
                    "平台设有\"猹馆\"（谐音茶馆）开放交流区，以及认证\"产品观猹员\"评分体系。\n\n"
                    "观猹的口号是\"玩 AI，上观猹！\"。"
                ),
                ft.Divider(height=16),
